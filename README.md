...
From repository root execute following commands to build dependencies:

```sh
dotnet build ./TechnitiumLibrary/TechnitiumLibrary/ -c Release
dotnet build ./TechnitiumLibrary/TechnitiumLibrary.Net/ -c Release
```

After this, you can work on app using your default IDE.
